...
NYC now requires companies using AI in hiring to conduct annual bias audits, publish results, and notify candidates that AI is being used. Other jurisdictions are following with similar requirements.
...
Frame HR AI as making people's work better, not eliminating jobs. Show how AI handles tedious screening so recruiters can spend time on relationship-building and candidate experience.
