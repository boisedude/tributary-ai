...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Agentic SaaS Advisory Services - Tributary AI",
    description:
      "Navigate the shift to outcome-based business models. Expert strategy for SaaS companies in the agentic era.",
    type: "website",
  },
};

export default function AgenticAdvisoryPage() {
  if (!service) {
    return null;
  }
        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-4 text-lg text-white/90">
              Let&apos;s discuss how to position your SaaS company for the outcome-based future.
            </p>
